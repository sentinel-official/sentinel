...
public class RestoreKeystoreRepository {
    // For Singleton instantiation
    private static final Object LOCK = new Object();
    private static RestoreKeystoreRepository sInstance;
    private final AppExecutors mAppExecutors;
    private final SingleLiveEvent<Resource<String>> mRestoreLiveEvent;

    private RestoreKeystoreRepository(AppExecutors iAppExecutors) {
        mAppExecutors = iAppExecutors;
        mRestoreLiveEvent = new SingleLiveEvent<>();
    }

    public static RestoreKeystoreRepository getInstance(AppExecutors iAppExecutors) {
        if (sInstance == null) {
            synchronized (LOCK) {
                sInstance = new RestoreKeystoreRepository(iAppExecutors);
            }
        }
        return sInstance;
    }

    public SingleLiveEvent<Resource<String>> getRestoreLiveEvent() {
        return mRestoreLiveEvent;
    }

    public void restoreKeystoreFile(String iPassword, String iKeystorePath, String iFilePath) {
