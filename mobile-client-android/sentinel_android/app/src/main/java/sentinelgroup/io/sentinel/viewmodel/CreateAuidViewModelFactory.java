...
public class CreateAuidViewModelFactory extends ViewModelProvider.NewInstanceFactory {
    ...
    public CreateAuidViewModelFactory(CreateAuidRepository iRepository, AppExecutors iAppExecutors) {
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        ...
        return (T) new CreateAuidViewModel(mRepository,mAppExecutors);
    }
}
