...
public class VpnDetailAdapter extends RecyclerView.Adapter<VpnDetailAdapter.ViewHolder>{

    private List<VpnDetailListData> mData;
    private final Context mContext;

    public VpnDetailAdapter(Context iContext, List<VpnDetailListData> iData) {
        mContext = iContext;
        mData=iData;
    }
