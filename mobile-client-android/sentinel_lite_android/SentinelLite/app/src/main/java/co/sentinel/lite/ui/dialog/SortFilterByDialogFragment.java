...
public class SortFilterByDialogFragment extends BottomSheetDialogFragment {
    ...
    private GenericAdapter.OnItemClickListener mItemClickListener = new GenericAdapter.OnItemClickListener() {
        @Override
    ...
    private void initView(View iView) {
        ...
        mAdapter = new GenericAdapter(mItemClickListener, getActivity());
