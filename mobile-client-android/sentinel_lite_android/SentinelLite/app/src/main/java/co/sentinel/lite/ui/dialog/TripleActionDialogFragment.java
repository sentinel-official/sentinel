...
public class TripleActionDialogFragment extends DialogFragment {
    ...
    public interface OnDialogActionListener {
         ...
         * @param iButtonType [int] Indicates if the type of button pressed {@link co.sentinel.lite.util.AppConstants.POSITIVE_BUTTON}, {@link co.sentinel.lite.util.AppConstants.NEGATIVE_BUTTON}, {@link co.sentinel.lite.util.AppConstants.NEUTRAL_BUTTON}
         */
