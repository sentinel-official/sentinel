...
func NewGaiaApp(logger log.Logger, db dbm.DB, traceStore io.Writer, baseAppOptions ...func(*bam.BaseApp)) *GaiaApp {
	...
	app.sentinelKeeper = sent.NewKeeper(app.cdc, app.keySentinel, app.coinKeeper, app.RegisterCodespace(stake.DefaultCodespace))
	...
	app.Router().
		...
		AddRoute("sentinel", sent.NewHandler(app.sentinelKeeper, app.accountMapper))
