...
class GetSock5Creds(object):
    def on_post(self, req, res):
        """
        @api {POST} //credentials for connecting to a SOCKS5 Node
        @apiName GetSocks5Credentials
        @apiGroup Session
        ...
        if client is not None:
            ...
            json_data = json.load(
                open('/root/sentinel/shell_scripts/shadowsocks.json'))
