...
export const ETH_TEST_HISTORY = 'ETH_TEST_HISTORY';
...
export const SET_CONNECTION_ESTABLISHING_STATUS = 'SET_CONNECTION_ESTABLISHING_STATUS';
export const DOCKER_IMAGES = 'DOCKER_IMAGES';
export const DOCKER_IMAGES_ERR = 'DOCKER_IMAGES_ERR';
export const IMAGE_CLIENTS = 'IMAGE_CLIENTS';
export const DOCKER_CONTAINERS = 'DOCKER_CONTAINERS';
export const LOGOUT_NODE = 'LOGOUT_NODE';
export const CONNECT_STATUS = 'CONNECT_STATUS';
export const NM_CONNECT_ERR = 'NM_CONNECT_ERR';
export const NM_CONNECT_SUCCESS = "NM_CONNECT_SUCCESS";
export const ETH_LOGGED = "ETH_LOGGED";
export const IS_ACCOUNT_VERIFIED = 'IS_ACCOUNT_VERIFIED';
export const SET_PROTOCOL_TYPE = "SET_PROTOCOL_TYPE";
export const MONIKER_VALUE = 'MONIKER_VALUE';
