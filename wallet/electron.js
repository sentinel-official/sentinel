...
function windowManager() {
  ...
  this.createWindow = () => {
    ...
    this.window = new BrowserWindow({ title: "Sentinel-alpha-0.0.42", resizable: false, maximizable: false, width: 1000, height: screenHeight, icon: './public/icon256x256.png' });
